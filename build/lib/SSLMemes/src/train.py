...
if __name__ == "__main__":
    ...
    parser.add_argument('--img_feature_path', type=str,default="/content/project/SSLMemes/data/features/visualbert/")
    parser.add_argument('--train_csv_path', type=str, default="/content/project/SSLMemes/data/splits/random/memotion_train.csv")
    parser.add_argument('--val_csv_path', type=str, default="/content/project/SSLMemes/data/splits/random/memotion_val.csv")
    ...
    parser.add_argument('--hyper_yaml_path', type=str, default="/content/project/SSLMemes/config/hyper1.yml")
