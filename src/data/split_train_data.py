...
parser.add_argument('--train_csv_path', type=str, default="data/MAMI_processed/train_b.csv")
...
df_labeled.to_csv(os.path.join(args.save_dir,f"train_b_labeled_ratio-{args.label_ratio}.csv"), index=False)
df_unlabeled.to_csv(os.path.join(args.save_dir,f"train_b_unlabeled_ratio-{args.label_ratio}.csv"), index=False) 